...
# Форматированный вывод
# ------------------------------------------------------------------------------------------------------
print("Message: {0} {1} {add_msg}".format("Hello","World",add_msg="!!!"))# вставка форматированной строки
print("Hello","World") # конкатенация через пробел
print("Hello","World", sep=":",end="\n")
print("Программа номер %2d, получила результат: %5.2f" % (4, 7.3333)) # %(флаги)(ширина)(.точность)тип
print("Результат {w:.2f}".format(w=7.3333))
